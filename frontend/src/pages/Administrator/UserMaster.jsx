...
const rows = [
  [
    ...
    "EMP-1042",
    "Indexing Ops",
    <Chip label="INDEXER" size="small" color="primary" />,
    "Rohan Mehta",
    "3",
    "ACTIVE",
  ],
  ...
  [
    ...
    "EMP-0310",
    "Production Core",
    <Chip label="CORE TEAM" size="small" color="primary" />,
    "—",
    "All",
    "ACTIVE",
  ],
  ...
  [
    <Person initials="KP" name="Karan Patel" />,
    "EMP-1130",
    "Indexing Ops",
    <Chip label="INDEXER" size="small" color="primary" />,
    "Rohan Mehta",
  ...
  [
    <Person initials="SA" name="System Admin" />,
    "EMP-0001",
    "IT / Admin",
...
const fields = [
  { name: "employee", label: "Employee name", placeholder: "Full name" },
  {
    name: "email",
    label: "Email",
  ...
  { name: "department", label: "Department", placeholder: "Indexing Ops" },
  {
    name: "designation",
    label: "Designation",
