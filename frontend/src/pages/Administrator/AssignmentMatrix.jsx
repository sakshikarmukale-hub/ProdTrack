...
const PROJECTS = ["ABC", "ORTHO", "SPINE", "CARDIO", "NEURO"];
  ...
  return (
    <Box
      ...
      sx={{
        ...
        "&:hover": locked ? {} : { transform: "scale(1.3)" },
      }}
    />
  );
}
...
export default function AssignmentMatrix() {
  ...
  return (
    <Box sx={{ width: "100%" }}>
      {/* ── PAGE HEADER ── */}
      <Typography sx={{ color: "#6b7b91", fontSize: 12, mb: 0.4 }}>
      ...
      >
        <Box>
          <Typography sx={{ fontSize: 23, fontWeight: 800, color: "#17233a" }}>
            Project assignment matrix
          </Typography>
          <Typography sx={{ color: "#718096", fontSize: 12, mt: 0.4 }}>
      ...
      >
        <InfoOutlinedIcon
          sx={{ fontSize: 16, color: "#2458c7", flexShrink: 0 }}
        />
        <Typography sx={{ fontSize: 12, color: "#2458c7" }}>
          ...
          {users.map((user, ui) => (
            ...
            >
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1.2 }}>
                ...
                <Typography
                  sx={{ fontSize: 13, color: "#17233a", fontWeight: 500 }}
                >
                  {user.name}
                </Typography>
              </Box>
